                    ...
                    <table class="table table-bordered">
                      ...
                      ?>
                        <tr>
                          ...
                          <td class="text-center">
                            <a class="btn btn-sm btn-warning" href="<?= base_url('admin/Katalog/edit?id=') . $row->catalogue_id ?>"
                            title="Edit">Edit</a>
                            <a class="btn btn-sm btn-danger" href="<?= base_url('admin/Katalog/delete?id=') . $row->catalogue_id ?>" 
                            title="Hapus" onclick="if (! confirm('Apakah anda yakin akan menghapus Katalog ini?')) { return FALSE; }">Delete</a>
                          </td>
                        </tr>
                      <?php endforeach; ?>
