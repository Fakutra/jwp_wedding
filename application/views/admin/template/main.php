...
<head>
  ...
  <!-- endinject -->
  <link rel="shortcut icon" href="<?= base_url('assets/landing'); ?>/img/couple.png" />
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-1" href="Dashboard"><img src="<?= base_url('assets/landing'); ?>/img/couple.png" class="mr-3" alt="logo"/>JeWePe WO</a>
        <a class="navbar-brand brand-logo-mini" href="Dashboard"><img src="<?= base_url('assets/landing'); ?>/img/couple.png" alt="logo"/></a>
      </div>
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?= base_url('admin/Laporan'); ?>">
              <i class="icon-paper menu-icon"></i>
              <span class="menu-title">Laporan Pesanan</span>
            </a>
          </li>
        </ul>
      </nav>
